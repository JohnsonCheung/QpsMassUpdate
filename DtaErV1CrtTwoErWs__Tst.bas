Attribute VB_Name = "DtaErV1CrtTwoErWs__Tst"
Option Explicit
...
DtaErOpt_Push_DupSku D, eWrkWs, Key, "A1", 123
DtaErOpt_Push_NoOrgRow D, "A1", Key
DtaErOpt_Push_ValTy D, eOrgWs, Key, F(0), "AA", 1, "Empty"
'---
Dim WrkWs As Worksheet
    Set WrkWs = Src.Wrk.Ws
DtaEr_DoCrt_ErWs D, WrkWs, eV3SelInEr
'DtaErOpt_CrtTwoErWs Src_Wb, D.Sz > 0, D.Ay
End Sub
